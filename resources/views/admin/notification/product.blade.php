		...
		@foreach($datas as $data)
			<li>
				<a href="{{ route('admin-prod-edit',$data->product->id) }}"> <i class="sagor"></i> {{mb_strlen($data->product->name,'utf-8') > 30 ? mb_substr($data->product->name,0,30,'utf-8') : $data->product->name}}
