                        ...
                        @if($order->shipping == "pickup")
                            <div class="col-lg-6">
                                <div class="invoice__shipping">
                                    <p><strong>{{ __('Pickup Location') }}</strong></p>
                                    <span><strong>Location</strong>: {{$order->pickup_location}}</span><br>
                                </div>
                            </div>
                        @else
                        <div class="col-lg-6">
                                            ...
                                            <tr>
                                                <td width="50%">
                                                    @if($product['item']['user_id'] != 0)
                                                        ...
                                                        @if(isset($user))
                                                            <a target="_blank"
                                                               href="{{ route('front.product', $product['item']['slug']) }}">@if(isJson($product['item']['name'])){{ json_decode($product['item']['name'] ,true)[$langg->id]}}@else {{$product['item']['name']}} @endif
                                                            </a>
                                                        @else
                                                            <a href="javascript:;">@if(isJson($product['item']['name'])){{ json_decode($product['item']['name'] ,true)[$langg->id]}}@else {{$product['item']['name']}} @endif</a>
                                                        @endif

                                                    @else
                                                        <a href="javascript:;">@if(isJSON($product['item']['name'] )){{json_decode($product['item']['name'] ,true)[$langg->id]}}@else {{$product['item']['name'] }} @endif
                                                        </a>
