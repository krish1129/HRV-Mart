                                                    ...
                                                    @if(isset($user))
                                                        <a target="_blank"
                                                           href="{{ route('front.product', $product['item']['slug']) }}">
                                                            @if(isJSON($product['item']['name'])){{ mb_strlen(json_decode($product['item']['name'],true)[$alang->id],'utf-8') > 30 ? mb_substr(json_decode($product['item']['name'],true)[$langg->id],0,30,'utf-8').'...' : json_decode($product['item']['name'],true)[$alang->id] }}@else{{ mb_strlen($product['item']['name'],'utf-8') > 30 ? mb_substr($product['item']['name'],0,
30,'utf-8').'...' : $product['item']['name'] }} @endif
                                                        </a>
                                                    @else
                                                        <a target="_blank"
                                                           href="{{ route('front.product', $product['item']['slug']) }}">
                                                            @if(isJSON($product['item']['name'])){{ mb_strlen(json_decode($product['item']['name'],true)[$alang->id],'utf-8') > 30 ? mb_substr(json_decode($product['item']['name'],true)[$langg->id],0,30,'utf-8').'...' : json_decode($product['item']['name'],true)[$alang->id] }}@else{{ mb_strlen($product['item']['name'],'utf-8') > 30 ? mb_substr($product['item']['name'],0,30,'utf-8').'...' : $product['item']['name'] }} @endif
                                                        </a>
                                                    @endif
                                                @else
