                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="left-area">
                                                        ...
                                                        <p class="sub-heading">In {{$language->language}}</p>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
                                                    ...
                                                    @if($data->subcategory_id == null)
                                                        @foreach($data->category->subs as $sub)
                                                            <option
                                                                ...
                                                                value="{{$sub->id}}">
                                                                @if(isJSON($sub->name)){{json_decode($sub->name,true)[$langg->id]}}@else {{$sub->name}} @endif
                                                            </option>
                                                        @endforeach
                                                    @else
                                                        @foreach($data->category->subs as $sub)
                                                        ...
                                                        @if($data->childcategory_id == null)
                                                            @foreach($data->subcategory->childs as $child)
                                                                <option value="{{$child->id}}">
                                                                    @if(isJSON($child->name)){{json_decode($child->name,true)[$langg->id]}}@else {{$child->name}} @endif
                                                                </option>
                                                            @endforeach
                                                        @else
                                                            @foreach($data->subcategory->childs as $child)
                                                                <option
                                                                    value="{{$child->id}} " {{$child->id == $data->childcategory_id ? "selected":""}}>
                                                                    @if(isJSON($child->name)){{json_decode($child->name,true)[$langg->id]}}@else {{$child->name}} @endif
                                                                    </option>
                                                            @endforeach
                                                        @endif
                                        ...
                                        @foreach($languages as $language)
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="left-area">
                                                        <h4 class="heading">
                                                            {{ __('Product Description(IN '.$language->language.')') }}*
                                                        </h4>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
                                                    <div class="text-editor">
                                                    <textarea name="details[{{$language->id}}]"
                                                              class="nic-edit-p">@if(isJSON($data->details)){{json_decode($data->details,true)[$language->id]}}@else {{$data->details}} @endif</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
                                        ...
                                        @foreach($languages as $language)
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="left-area">
                                                        <h4 class="heading">
                                                            {{ __('Product Buy/Return Policy (IN '.$language->language.')') }}
                                                            *
                                                        </h4>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
                                                    <div class="text-editor">
                                                    <textarea name="policy[{{$language->id}}]"
                                                              class="nic-edit-p">@if(isJSON($data->policy)){{json_decode($data->policy,true)[$language->id]}}@else {{$data->policy}} @endif</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
                            ...
                            <div class="col-lg-12">
                                <div class="product-description">
                                    <div class="body-area">
                                        ...
                                        <input type="hidden" id="feature_photo" name="photo" accept="image/*">
