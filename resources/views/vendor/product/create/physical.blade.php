                                    ...
                                    <div class="body-area">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <input type="text" class="input-field"
                                                           placeholder="{{ $langg->lang632 }} In {{$language->language}}"
                                                           name="name[{{$language->id}}]" required="">
                                                </div>
                                            </div>
                                        @endforeach
                                        ...
                                        @foreach($languages as $language)
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="left-area">
                                                        <h4 class="heading">
                                                            {{ $langg->lang680 .' (In '. $language->language.')' }}*
                                                        </h4>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
                                                    <div class="text-editor">
                                                        <textarea class="nic-edit-p" name="details[{{$language->id}}]"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="left-area">
                                                    <h4 class="heading">
                                                        {{ $langg->lang681 .' (In '. $language->language.')'}}*
                                                    </h4>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="text-editor">
                                                    <textarea class="nic-edit-p" name="policy[{{$language->id}}]"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
