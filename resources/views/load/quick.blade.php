...
<div class="right-area">
  <div class="product-info">
      <h4 class="product-name"><a target="_blank" href="{{ route('front.product',$product->slug) }}">
              @if(isJSON($product->name)){{json_decode($product->name,true)[$langg->id]}}@else {{$product->name}} @endif
             </a></h4>
      ...
      <div class="info-meta-3">
          <ul class="meta-list">
            ...
            @endif
              ...
              @else
              <li class="addtocart">
                <a href="javascript:;" id="maddcrt"><i class="sagor"></i>{{ $langg->lang90 }}</a>
              </li>
