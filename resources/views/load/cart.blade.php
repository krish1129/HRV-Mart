									@if(Session::has('cart'))
										<div class="dropdownmenu-wrapper">
												<div class="dropdown-cart-header">
													...
													<a class="view-cart" href="{{ route('front.checkout') }}">
													{{ $langg->lang7 }}
													</a>
