									...
									<div class="col-lg-2 col-md-2 col-6 p-1">
										<a href="{{ route('front.product', $prod->slug) }}" class="item">
											<div class="item-img">
												...
												<img class="img-fluid" src="{{ $prod->thumbnail ? asset('assets/images/thumbnails/'.$prod->thumbnail):asset('assets/images/noimage.png') }}" alt="" style="width: 200px; margn: auto">
											</div>
											<div class="info">
                                                <h5 class="name">@if(isJson($prod->showName())){{ json_decode($prod->showName() ,true)[$langg->id]}}@else {{$prod->showName()}} @endif</h5>
												<div class="stars">
                                            <div class="ratings">
                                                ...
                                                @php
                                                    $price = preg_replace('/[^0-9,.]+/', '', $prod->setCurrency());
