<li>
        ...
        <ul class="collapse list-unstyled" id="order" data-parent="#accordion" >
            ...
            <li>
                <a href="{{route('admin-order-delivery')}}"> {{ __('On Delivery Orders') }}</a>
            </li>
            <li>
    ...
    <li>
        <a href="#affiliateprod" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="sagor"></i>{{ __('Affiliate Products') }}
        </a>
  ...
  {{--  <li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="homepage" data-parent="#accordion">
            ...
            <li>
                <a href="{{route('admin.image')}}"><span>{{ __('Side Image') }}</span></a>
            </li>
            <li>
                <a href="{{route('admin.top_popup')}}"><span>{{ __('Top Popup Image') }}</span></a>
            </li>
            <li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="menu" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin.contact') }}"><span>{{ __('Help Number') }}</span></a>
            </li>
            <li>
