      ...
      <div class="row">
         <div class="col-lg-12">
            <ul class="pages">
               ...
               @if (!empty($cat))
               <li>
                  <a href="{{route('front.category', $cat->slug)}}">@if(isJson($cat->name )){{ json_decode($cat->name,true)[$langg->id]}}@else {{$cat->name }} @endif</a>
               </li>
               @endif
               @if (!empty($subcat))
               <li>
                  <a href="{{route('front.category', [$cat->slug, $subcat->slug])}}">@if(isJson($subcat->name )){{ json_decode($subcat->name,true)[$langg->id]}}@else {{$subcat->name }} @endif</a>
               </li>
               @endif
               @if (!empty($childcat))
               <li>
                  <a href="{{route('front.category', [$cat->slug, $subcat->slug, $childcat->slug])}}">@if(isJson($childcat->name )){{ json_decode($childcat->name,true)[$langg->id]}}@else {{$childcat->name}} @endif</a>
               </li>
               @endif
...
<section class="sub-categori mt-2">
   <div class="container-fluid">
      <div class="row">
