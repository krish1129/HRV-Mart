...
@section('content')
                ...
                <div class="col-lg-8">
                    ...
                    <form id="" action="" method="POST" class="checkoutform">
                                ...
                                <div class="tab-pane fade show active" id="pills-step1" role="tabpanel"
                                    ...
                                    <div class="content-box">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12  mt-3">
                                                    <div onclick="topFunction()" class="bottom-area paystack-area-btn">
                                                        <button type="submit"
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="nav flex-column" role="tablist"
                                                            ...
                                                            @if ($gs->cod_check == 1)
                                                                ...
                                                                @endif
                                                            @endif
                                                            <a class="nav-link" href="#" onClick="nicepayStart();">
                                                                <div class="icon">
                                                                    <span class="radio"></span>
                                                                </div>
                                                                <p>
                        ...
                        @if (Session::has('coupon_total'))
                            <input type="hidden" class="grandtotal" name="total" id="grandtotal"
                                value="{{ $totalPrice }}">
                            ...
                            <div class="order-box">
                                ...
                                @if ($digital == 0)
                                    ...
                                    <div class="packeging-area"
                                        @if ($gs->multiple_shipping != 1) style='display: none' @endif>
    ...
    <div id="auth_form" class="auth_form_hide text-center mb-4">
        <?php
        ...
        $merchantKey = '33F49GnCMS1mFYlGXisbUDzVf2ATWCl9k3R++d5hDd3Frmuos/XLx8XhXpe+LDYAbpGKZYSwtlyyLOtS/8aD7A=='; // merchantKey
        $MID = 'nictest00m'; // merchantID
        $buyerName = 'NICE'; // buyer name
        $buyerTel = '01000000000'; // buyer contact
        $buyerEmail = 'happy@day.co.kr'; // buyer email
        $moid = 'mnoid1234567890'; // order id
        $returnURL = route('front.checkout'); // absolute path, mobile payment only
        ...
        if (Session::has('coupon_total')) {
            ...
            $price = Session::get('coupon_total1');
        } else {
            $price = $totalPrice;
        }
        $ediDate = date('YmdHis');
        ...
        ?>
        <?php echo '<script> var ediDate = String(' . $ediDate . ');</script>'; ?>
        <form name="payForm" method="post" action="#">
            <table>
                <tr>
                    {{-- <th>PayMethod</th> --}}
                    <td><input type="hidden" name="PayMethod" value="CARD"></td>
                </tr>
                <tr>
                    {{-- <th>GoodsName</th> --}}
                    <td><input type="hidden" name="GoodsName"
                            value="@foreach ($products as $product) @if (isJson($product['item']['name'])){{ json_decode($product['item']['name'], true)[$langg->id] }}@else {{ $product['item']['name'] }} @endif , @endforeach">
                    </td>
                </tr>
                <tr>
                    {{-- <th>Amt</th> --}}
                    <td>
                        {{-- <input type="text" name="Amt" class="grandtotal" id="myInput1" value="{{preg_replace("/[^0-9,.]/", "",$price)}}"> --}}
                        ...
                        @if (Session::has('coupon_total'))
                            <input type="hidden" class="grandtotal" name="Amt" value="{{ $totalPrice }}">
                            {{-- <input type="hidden" id="tgrandtotal" value="{{ $totalPrice }}"> --}}
                        @elseif(Session::has('coupon_total1'))
                            <input type="hidden" class="grandtotal" name="Amt"
                                value="{{ preg_replace('/[^0-9,.]/', '', Session::get('coupon_total1')) }}">
                ...
                <tr>
                    {{-- <th>hashString</th> --}}
                    <td>
                        <input type="hidden" name="SignData" id="myInput2" value="{{ $hashString }}" />
                ...
                <tr>
                    {{-- <th>Moid</th> --}}
                    <td><input type="hidden" name="Moid" value="<?php echo $moid; ?>"></td>
                </tr>
                <tr>
                    {{-- <th>BuyerName</th> --}}
                    <td><input type="hidden" name="BuyerName" value="<?php echo $buyerName; ?>"></td>
                </tr>
                <tr>
                    {{-- <th>BuyerEmail</th> --}}
                ...
                <tr>
                    {{-- <th>BuyerTel</th> --}}
                    <td><input type="hidden" name="BuyerTel" value="<?php echo $buyerTel; ?>"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="hidden" name="VbankExpDate"
                            value="{{ date('Ymd', strtotime(now('Asia/Dhaka'))) }}"></td>
                </tr>
                ...
                {{-- <input type="hidden" name="SignData" value="{{bin2hex(hash('sha256', $ediDate . $MID . "<script>{test}</script>" . $merchantKey, true))}}"/> --}}
                {{-- <input type="hidden" name="SignData" value="{{"<script>document.writeln(test);</script>"}}"/> --}}
                {{-- <input type="text" name="SignData" id="myInput2" value="{{$hashString}}"/> --}}
                <!-- EncryptData -->
            </table>
            {{-- <a href="#" class="btn_blue" onClick="nicepayStart();">REQUEST</a> --}}
        </form>
        <div class="container-fluid">
            <script _ajs_='48_52c9c40b61b7ae3a' _ah_='19193623'>
            ...
            <a href="javascript:onPopAuthMark('cf00d5326bba43d11309a5c0d66c48ed')"><img
                    src='https://kiup.ibk.co.kr/IBK/uib/ecb/img/KO/esc/sub/imgIbkMark.gif' alt='인증마크'
                    border='0' /></a>
        </div>
    </div>
                            ...
                            <div class="tab-pane fade show active" id="nav-log" role="tabpanel"
                                ...
                                <div class="login-area">
                                    ...
                                    <div class="login-form signin-form">
                                        ...
                                        <form id="" action="{{ route('user.login.submit') }}" method="POST">
                                            {{ csrf_field() }}
                                            <div class="form-input">
                                                <input type="email" name="email"
                                                    placeholder="{{ $langg->lang173 }}" value="" required="">
                                                <i class="icofont-user-alt-5"></i>
                                            </div>
                                            <div class="form-input">
                                                <input type="password" class="Password" name="password"
                                                    placeholder="{{ $langg->lang174 }}" value="" required="">
                            ...
                            <div class="tab-pane fade" id="nav-reg" role="tabpanel" aria-labelledby="nav-reg-tab">
                                <div class="login-area signup-area">
                                    ...
                                    <div class="login-form signup-form">
                                        @include('includes.admin.form-login')
                                        <form id="" action="{{ route('user-register-submit') }}"
                                            method="POST">
                                            {{ csrf_field() }}
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $('#myInput2').val(sha256.hex(ediDate + 'nictest00m' + ftotal +
        ...
        $('.shipping').on('click', function() {
            ...
            $('#myInput2').val(sha256.hex(ediDate + 'nictest00m' + ttotal +
                '33F49GnCMS1mFYlGXisbUDzVf2ATWCl9k3R++d5hDd3Frmuos/XLx8XhXpe+LDYAbpGKZYSwtlyyLOtS/8aD7A=='));
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data == 0) {
                        ...
                        $('#myInput2').val(sha256.hex(ediDate + 'nictest00m' + data[0] +
    ...
    <script type="text/javascript">
        ...
        $('.checkoutform').on('submit', function(e) {
            ...
            auth_form.removeClass('auth_form_hide');
            auth_form.addClass('auth_form_open');
        ...
        $('#step2-btn').on('click', function() {
            ...
            var auth_form = $('#auth_form');
            auth_form.removeClass('auth_form_open');
            auth_form.addClass('auth_form_hide');
