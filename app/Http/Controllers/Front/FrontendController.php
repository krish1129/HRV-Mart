...
// -------------------------------- HOME PAGE SECTION ----------------------------------------
    ...
    public function index(Request $request)
    {
        ...
        $feature_products = Product::where('featured', '=', 1)->where('status', '=', 1)->select($selectable)->orderBy('id', 'desc')->take(30)->get();
       // $images=Image::all();
    ...
    public function extraIndex()
    {
        ...
        $best_products = Product::where('best', '=', 1)->where('status', '=', 1)->select($selectable)->orderBy('id', 'desc')->take(30)->get();
        $top_products = Product::where('top', '=', 1)->where('status', '=', 1)->select($selectable)->orderBy('id', 'desc')->take(30)->get();;
        $big_products = Product::where('big', '=', 1)->where('status', '=', 1)->select($selectable)->orderBy('id', 'desc')->take(30)->get();;
...
// -------------------------------- FAQ SECTION ----------------------------------------
    public function faq()
    {
        ...
        return view('front.faq', compact('faqs','contacts'));
    }
// -------------------------------- FAQ SECTION ENDS----------------------------------------
...
public function load(Request $request) {
    if($request->ajax()) {
        if($request->id > 0) {
            $selectable = ['id', 'user_id', 'name', 'slug', 'features', 'colors', 'thumbnail', 'price', 'previous_price', 'attributes', 'size', 'size_price', 'discount_date'];
            $data = Product::where('id','<',$request->id)->where('featured', '=', 1)->where('status', '=', 1)->orderBy('id', 'desc')->select($selectable)->take(6)->get();
        }else {
            $selectable = ['id', 'user_id', 'name', 'slug', 'features', 'colors', 'thumbnail', 'price', 'previous_price', 'attributes', 'size', 'size_price', 'discount_date'];
            $data = Product::where('featured', '=', 1)->where('status', '=', 1)->orderBy('id', 'desc')->select($selectable)->take(30)->get();
        }
        return view('front.ajax-load.load',compact('data'));
    }
}
