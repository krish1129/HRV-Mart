...
class SubCategoryController extends Controller
{
        ...
        foreach ($datas as $data) {
         ...
         return Datatables::of($items)
                            ->addColumn('category', function(Subcategory $data) {
                                ...
                                if (isJSON($data->category->name)) {
                                    $name = json_decode($data->category->name, true)[$language->id];
                                }
    ...
    public function create()
    {
        ...
        return view('admin.subcategory.create',compact('cats','languages'));
    }
    ...
    public function edit($id)
    {
        ...
        $languages = Language::all();
        return view('admin.subcategory.edit',compact('data','cats','languages'));
    }
