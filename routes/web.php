...
Route::post('/load/more/data',[FrontendController::class,'load'])->name('loadmore.load_data');
Route::post('/load/more/best-sell',[FrontendController::class,'bestSell'])->name('loadmore.best_sell');
...
// Product Notification
    ...
    Route::get('/product/notf/count', [App\Http\Controllers\Admin\NotificationController::class, 'product_notf_count'])->name('product-notf-count');
...
//------------ ADMIN ORDER SECTION ------------
    ...
    Route::group(['middleware' => 'permissions:orders'], function () {
        ...
        Route::get('/orders/on-delivery', [\App\Http\Controllers\Admin\OrderController::class, 'delivery'])->name('admin-order-delivery');
...
Route::get('/order/track/{id}', [FrontendController::class, 'trackload'])->name('front.track.search');
...
//Top Image
Route::get('/admin/images',[\App\Http\Controllers\Admin\ImageController::class,'index'])->name('admin.image');
Route::post('/admin/images/update',[\App\Http\Controllers\Admin\ImageController::class,'update'])->name('admin.image.update');
//Top Pop up banner
Route::get('/admin/top_popups',[\App\Http\Controllers\Admin\TopPopupController::class,'index'])->name('admin.top_popup');
Route::post('/admin/top_popups/update',[\App\Http\Controllers\Admin\TopPopupController::class,'update'])->name('admin.top_popup.update');
//Contact Controller
Route::get('/admin/contacts',[\App\Http\Controllers\Admin\ContactController::class,'index'])->name('admin.contact');
Route::get('/admin/contacts/create', [\App\Http\Controllers\Admin\ContactController::class, 'create'])->name('admin.contact.create');
Route::post('/admin/contacts/create', [\App\Http\Controllers\Admin\ContactController::class, 'store']);
Route::get('/admin/contacts/edit/{id}', [\App\Http\Controllers\Admin\ContactController::class, 'edit'])->name('admin.contact.edit');
Route::post('/admin/contacts/edit/{id}', [\App\Http\Controllers\Admin\ContactController::class, 'update']);
Route::get('/admin/contacts/delete/{id}', [\App\Http\Controllers\Admin\ContactController::class, 'delete'])->name('admin.contact.delete');
